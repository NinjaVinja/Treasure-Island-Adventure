...
print("Ahoy, adventurer! Your mission is to find the treasure.")
...
if(left_or_right.lower() == "left"):
    ...
    if(swim_or_wait.lower() == "wait"):
        ...
        if(door.lower() == "red"):
            print("\n Unfortunately! You are Burned with fire. \nGame Over.")
...
''')
            ...
            print("\n Unfortunately! You are Eaten by beasts. \nGame Over.")
        else:
            print("\n That's not a valid door.\n Game Over.")
    else:
        print("\n Unfortunately! You were attacked by a trout. \n Game Over.")
else:
    print("\n Unfortunately! You fell into a hole. \n Game Over.")
